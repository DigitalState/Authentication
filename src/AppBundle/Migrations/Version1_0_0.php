    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('
            ...
            VALUES 
                ...
                (4, \''.Uuid::uuid4()->toString().'\', \'BusinessUnit\', \''.$data['business_unit']['administration']['uuid'].'\', \'app.registration.individual.owner_uuid\', \''.$data['business_unit']['backoffice']['uuid'].'\', true, 1, \''.$data['tenant']['uuid'].'\', now(), now()),
                ...
                (8, \''.Uuid::uuid4()->toString().'\', \'BusinessUnit\', \''.$data['business_unit']['administration']['uuid'].'\', \'app.registration.organization.owner_uuid\', \''.$data['business_unit']['backoffice']['uuid'].'\', true, 1, \''.$data['tenant']['uuid'].'\', now(), now()),
