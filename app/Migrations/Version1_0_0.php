...
class Version1_0_0 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('
            INSERT INTO 
                `ds_user` (`id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `uuid`, `owner`, `owner_uuid`, `identity`, `identity_uuid`, `version`, `created_at`, `updated_at`, `deleted_at`)
            VALUES 
        ...
        $this->addSql('
            ...
            VALUES 
                (1, \'f6751b55-653b-4a66-8b31-06ad2a3b52c2\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.services.identities.url\', \'https://api.ds\', 1, 1, now(), now()),
                (2, \'6928362f-5162-4c12-88fa-b77a9d6d9641\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.user\', \'system@ds\', 1, 1, now(), now()),
                (3, \'d4e199b3-e128-4e9f-bb82-f50704d05ce5\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.individual.role\', \'ROLE_INDIVIDUAL\', 1, 1, now(), now()),
                (4, \'296d729c-b18e-424f-913f-5121ee012865\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.individual.identity\', \'Individual\', 1, 1, now(), now()),
                (5, \'f246584b-d3af-42b1-8c8d-7cf1a650a739\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.individual.owner\', \'BusinessUnit\', 1, 1, now(), now()),
                (6, \'81f84145-56b5-4a3d-a8d7-9a4a7fe5adf0\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.individual.owner_uuid\', \'194671e9-12aa-41df-8feb-1ba45e4a71e6\', 1, 1, now(), now()),
                (7, \'b17c83be-c768-4352-a839-045048d0c0aa\', \'BusinessUnit\', \'ed1fe135-b791-4b8d-a033-acab9daa9853\', \'ds_registration.individual.enabled\', 1, 1, 1, now(), now());
        ');
    }
