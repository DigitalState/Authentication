...
Feature: Edit accesses
  ...
  Scenario: Edit an access
    ...
    And I send a "PUT" request to "/accesses/005f5f77-c43d-491b-92c8-d76c68924cf7" with body:
    """
    {
      "owner": "System",
  ...
  Scenario: Edit an access's read-only properties
    ...
    And the JSON node "uuid" should be equal to the string "005f5f77-c43d-491b-92c8-d76c68924cf7"
